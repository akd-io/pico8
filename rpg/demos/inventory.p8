...
function drawInventory(inventory, highlight, outerX, outerY)
  ...
  for column = 1, columns do
    for row = 1, rows do
      ...
      if (item ~= nil) then
        ...
        roundRect(x, y, x + cellWidth - 1, y + cellHeight - 1, getTier(item))
...
function _draw()
  ...
  local items = currentInventory.items

  -- Draw selected item
  local selectedItem = items[(highlight.y - 1) * currentInventory.columns + highlight.x]
  if (selectedItem ~= nil) then
    drawItem(selectedItem, 0, 72)
  end
end
...

