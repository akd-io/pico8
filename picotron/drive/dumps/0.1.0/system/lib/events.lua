...
do
	...
	local name_to_scancode =
	{
		...
		lctrl=57,rctrl=228,lshift=225,rshift=229,lalt=226,ralt=226, -- !! don't know ralt cause remapped on robot atm!
	...
	function key(scancode)
		-- how to do meta keys efficiently? should have look-up table of aliases
		if (scancode == "ctrl") then return key("lctrl") or key("rctrl") end
